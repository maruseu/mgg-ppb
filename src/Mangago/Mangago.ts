...
const SOURCE_DOMAIN = "https://mangago.me/"

export class Mangago extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Mangago' }
    get description(): string { return 'Mangago' }
    get author(): string { return '' }
